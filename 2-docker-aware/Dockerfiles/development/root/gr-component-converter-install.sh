...
# Build and install Geon's component converter
. /etc/profile
pushd /root/gr-component_converter
make install

# Copy front-end tooling to user's work area.
cp -r converter /home/user/converter
